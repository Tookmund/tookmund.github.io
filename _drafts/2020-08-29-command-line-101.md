...
shell always has a "working directory," to which all paths
...
For a better, but even more contrived example, say you have a file with a
bunch of lines of potentially duplicated and unsorted data
```
test
test
1234
